  ...
  page: {
    homePage: {
      ...
      description: {
        ...
        // lt: 'Programėlė "TaskMate" yra paprasta ir intuityvi užduočių sąrašo programa, leidžianti vartotojams kurti ir valdyti sukurtas užduotis. Ji turi patogią sąsają, kuri leidžia naujiems ar esamiems vartotojams lengvai prisijungti ir pasiekti savo asmeninį darbų sąrašą. Prisijungę vartotojai gali peržiūrėti dabartinį užduočių sąrašą ir greitai pridėti naujas užduotis, atnaujinti esamas užduotis, lengvai pašalinti jas iš sąrašo, kai užduočių nebereikia. Ši "TaskMate" programėlė yra patogus ir efektyvus įrankis visiems, norintiems nepamiršti savo dienotvarkės ir efektyviai valdyti savo kasdienes užduotis.',
